...
OUTPUT_SCRIPT="snake/snake_run_bugrepor.script"

# --- Step 2: Prompt user for the actual instruction ---
echo ""
echo "Acid Burn Reporting Interface Initialized."
echo "------------------------------------------"
echo "Please enter the specific instruction/question for the AI, starting with:"
...
if [[ -z "$USER_INPUT" ]]; then
    ...
    USER_INPUT="[No specific instruction provided.]"
fi
