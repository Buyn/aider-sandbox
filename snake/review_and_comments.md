# Bags reports
## что-то нето с управление "вверх" "вниз"
змейка перемешается хаотично а не сохраняеет координау.
возможно пробелема с пространстов 
поскольку нет отображения стен нельзя ответить ка оно отображается и строится.
возможно стоит для тестированая отобразить стены какимто символом временно.
или добавить опчию позволяюшию включать отображение стен.
